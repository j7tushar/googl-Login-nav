...
public class FragmentDrawer extends Fragment {
    ...
    private static int[] ic_nav_drw = {R.drawable.ic_setting, R.drawable.ic_map, R.drawable.ic_setting};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        circleImageView = (CircleImageView) layout.findViewById(R.id.u_image);
