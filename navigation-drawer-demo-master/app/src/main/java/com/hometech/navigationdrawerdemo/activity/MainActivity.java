...
public class MainActivity extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewName = (TextView) findViewById(R.id.u_name);
        textViewEmail = (TextView) findViewById(R.id.u_mail);
        circleImageView = (CircleImageView) findViewById(R.id.u_image);
